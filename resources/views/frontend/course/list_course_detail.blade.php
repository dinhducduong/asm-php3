                ...
                <div class="col-md-4">
                    <div class="card">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item"><strong>Bài giảng </strong>: {{$count_course_teachers}}</li>
                            ...
                            <li class="list-group-item"><strong>Trình độ</strong>: {{$detail_course[0]->education}}</li>
                            <li class="list-group-item"><a href="" class="btn btn-danger" >Đăng kí khóa học</a>
                                <p class="text-muted mb-0 mt-4">Liên hệ với giảng viên</p><a class="text-info" href="#">{{$detail_course[0]->email}}</a>
                            </li>
                        </ul>
                    </div>
                </div>
