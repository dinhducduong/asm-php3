    ...
    <section>
        ...
        <div class="container">
            <div class="row">
                ...
                <?php $__currentLoopData = $data_cource; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-4 mb-4">
                        <div class="card h-100"><img class="card-img-top w-100" src="<?php echo e($key->image); ?>" alt="courses" />
                            <div class="card-body">
                                ...
                                <a class="text-muted fs--1 stretched-link text-decoration-none" href="<?php echo e(route('detail_course', ['id' => $key->id])); ?>"><?php echo e($key->description_short); ?></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12 col-lg-6 h-100">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="card card-span bg-600">
                            <div class="card-body">
                                <div class="row flex-center gx-0">
                                    <div class="col-lg-4 col-xl-3 text-center text-xl-start"><img src="<?php echo e(asset('/assets/img/gallery/art-design.png')); ?>" width="120" alt="courses" /></div>
...
<?php echo $__env->make('frontend.home_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\asm_php3\resources\views/frontend/main.blade.php ENDPATH**/ ?>